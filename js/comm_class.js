...
var _C_URL_ = "http://studio2.local/r/html";
var _M_URL_ = "http://studio2.local/";

var SESSION = {};

var GV = {};

var __ss_url__ = "http://studio2.local/r/";
...
omegaCore.lang = {
		...
		loadLang: function (group, langId, source,callBack)
		{
			var data = {
					langGroup:group,
					langId:langId
			...
			t.addRawRequest(_C_URL_,"html/forms/fromJs/jsGetLangGroup",omegaCore.lang,[data,"setLang"]);
			t.sendData();
			
		},
		
		setLang:function (status,result){
			if (status)
			{
				console.log(result);
				...
				$.each(result, function (key,value){
					...
					var attr = $("#"+key).attr("data-tooltip");
					
					if (typeof attr !== typeof undefined && attr !== false) {
						  $("#"+key).attr("data-tooltip",value);
					}else{
						$("#"+key).html(value);
					}
				...
				pushWindow({caption:"Chyba",content:result});
			}
		}
}
...
//	console.log(["processed".__timeOutId]);
	...
	onlineRes.fncs.showProgressBar(true);
...
function transferComplete(e)
{
	...
	var target = e.target;
	onlineRes.fncs.showProgressBar(false);
	console.log(e);
